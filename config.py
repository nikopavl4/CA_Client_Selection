...
def federated_args():
    ...
    parser.add_argument('--fl_rounds', type=int, default=30, help="The number of federated rounds for model training.")
    parser.add_argument('--fraction', type=float, default=1., help="The fraction of clients to consider for local model training.")
    parser.add_argument('--aggregation', type=str, default="fednova", help="The federated aggregation algorithm.")
